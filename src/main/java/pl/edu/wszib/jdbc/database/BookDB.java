...
//    private BookDB(){
//        books.add(new Book("To Kill a Mockingbird", "Harper Lee", "0446310786", rs.getBoolean("rent")));
//        books.add(new Book("1984", "George Orwell", "0451524934", rs.getBoolean("rent")));
//        books.add(new Book("The Catcher in the Rye", "J.D. Salinger", "0316769487", rs.getBoolean("rent")));
//        books.add(new Book("The Great Gatsby", "F. Scott Fitzgerald", "0743273567", rs.getBoolean("rent")));
//        books.add(new Book("Pride and Prejudice", "Jane Austen", "0141439513", rs.getBoolean("rent")));
//        books.add(new Book("The Hobbit", "J.R.R. Tolkien", "054792822X", rs.getBoolean("rent")));
//        books.add(new Book("The Lord of the Rings", "J.R.R. Tolkien", "0544003411", rs.getBoolean("rent")));
//        books.add(new Book("The Da Vinci Code", "Dan Brown", "0307474275", rs.getBoolean("rent")));
//        books.add(new Book("Harry Potter and the Philosopher's Stone", "J.K. Rowling", "0747532699", rs.getBoolean("rent")));
//        books.add(new Book("The Hunger Games", "Suzanne Collins", "0439023483", rs.getBoolean("rent")));
//    }
